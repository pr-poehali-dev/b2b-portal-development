...
const Portfolio = () => {
  ...
  const projects = [
    {
      title: 'Портал для машиностроительного завода',
      description: 'Комплексное решение с интеграцией 1С, каталогом технических изделий и системой заказов',
      image: '/img/44146ae9-6074-4855-bb88-653dd4760e70.jpg',
      features: [
        'Интеграция с 1С:Предприятие',
        'Каталог на 15,000+ позиций',
        'Система согласования заказов',
        'Личные кабинеты для 200+ партнеров'
      ],
      tech: ['React', '1C', 'PostgreSQL', 'Redis']
    },
    {
      title: 'Складская система для производства',
      description: 'Автоматизация складских процессов с интеграцией WMS и системой отслеживания',
      image: '/img/1083f6fd-7072-4970-b52d-13e530a34382.jpg',
      features: [
        'Управление складскими остатками',
        'Интеграция с WMS системой',
        'Отслеживание партий товаров',
        'Аналитические отчеты'
      ],
      tech: ['Vue.js', 'SAP', 'MySQL', 'Docker']
    },
    {
