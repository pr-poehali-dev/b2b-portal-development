  ...
  const services = [
    {
      ...
      description: 'Синхронизация с 1С, SAP, Oracle, Microsoft Dynamics и другими корпоративными системами',
      features: [
        'Автоматическая синхронизация товаров и цен',
    ...
    {
      icon: 'FileText',
      title: 'Каталоги с техническими характеристиками',
      description: 'Создание подробных каталогов продукции с чертежами, спецификациями и 3D-моделями',
      features: [
        'Загрузка чертежей и технических схем',
        'Интерактивные 3D-модели изделий',
        'Конфигураторы для сложных товаров',
